...
pt2.AddText(str(DYToLLnums[1]))
pt2.AddLine(00, .200, 1.00, .200)
pt2.AddText(str(stnums[1]))
pt2.AddLine(00, .300, 1.00, .300)
pt2.AddText(str(tt_M2T4nums[1]))
pt2.AddLine(00, .400, 1.00, .400)
pt2.AddText(str(WToLNunums[1]))
pt2.AddLine(00, .500, 1.00, .500)
pt2.AddText(str(T_M1000_W10nums[1]))
pt2.AddLine(00, .600, 1.00, .600)
pt2.AddText(str(T_M1500_W10nums[1]))
pt2.AddLine(00, .700, 1.00, .700)
pt2.AddText(str(T_M2000_W10nums[1]))
pt2.AddLine(00, .800, 1.00, .800)
pt2.AddText(str(T_M2500_W10nums[1]))
pt2.AddLine(00, .900, 1.00, .900)
pt2.AddText(str(T_M3000_W10nums[1]))
pt2.Draw()

pt3.AddText("Leading Jet P_{t} > 185 GeV")
pt3.AddLine(00, .100, 1.00, .100)
pt3.AddText(str(DYToLLnums[2]))
pt3.AddLine(00, .200, 1.00, .200)
pt3.AddText(str(stnums[2]))
pt3.AddLine(00, .300, 1.00, .300)
pt3.AddText(str(tt_M2T4nums[2]))
pt3.AddLine(00, .400, 1.00, .400)
pt3.AddText(str(WToLNunums[2]))
pt3.AddLine(00, .500, 1.00, .500)
pt3.AddText(str(T_M1000_W10nums[2]))
pt3.AddLine(00, .600, 1.00, .600)
pt3.AddText(str(T_M1500_W10nums[2]))
pt3.AddLine(00, .700, 1.00, .700)
pt3.AddText(str(T_M2000_W10nums[2]))
pt3.AddLine(00, .800, 1.00, .800)
pt3.AddText(str(T_M2500_W10nums[2]))
pt3.AddLine(00, .900, 1.00, .900)
pt3.AddText(str(T_M3000_W10nums[2]))
pt3.Draw()

pt4.AddText("Sub-Leading Jet P_{t} > 50 GeV")
pt4.AddLine(00, .100, 1.00, .100)
pt4.AddText(str(DYToLLnums[3]))
pt4.AddLine(00, .200, 1.00, .200)
pt4.AddText(str(stnums[3]))
pt4.AddLine(00, .300, 1.00, .300)
pt4.AddText(str(tt_M2T4nums[3]))
pt4.AddLine(00, .400, 1.00, .400)
pt4.AddText(str(WToLNunums[3]))
pt4.AddLine(00, .500, 1.00, .500)
pt4.AddText(str(T_M1000_W10nums[3]))
pt4.AddLine(00, .600, 1.00, .600)
pt4.AddText(str(T_M1500_W10nums[3]))
pt4.AddLine(00, .700, 1.00, .700)
pt4.AddText(str(T_M2000_W10nums[3]))
pt4.AddLine(00, .800, 1.00, .800)
pt4.AddText(str(T_M2500_W10nums[3]))
pt4.AddLine(00, .900, 1.00, .900)
pt4.AddText(str(T_M3000_W10nums[3]))
pt4.Draw()

pt5.AddText("2D Lepton Isolation")
pt5.AddLine(00, .100, 1.00, .100)
pt5.AddText(str(DYToLLnums[4]))
pt5.AddLine(00, .200, 1.00, .200)
pt5.AddText(str(stnums[4]))
pt5.AddLine(00, .300, 1.00, .300)
pt5.AddText(str(tt_M2T4nums[4]))
pt5.AddLine(00, .400, 1.00, .400)
pt5.AddText(str(WToLNunums[4]))
pt5.AddLine(00, .500, 1.00, .500)
pt5.AddText(str(T_M1000_W10nums[4]))
pt5.AddLine(00, .600, 1.00, .600)
pt5.AddText(str(T_M1500_W10nums[4]))
pt5.AddLine(00, .700, 1.00, .700)
pt5.AddText(str(T_M2000_W10nums[4]))
pt5.AddLine(00, .800, 1.00, .800)
pt5.AddText(str(T_M2500_W10nums[4]))
pt5.AddLine(00, .900, 1.00, .900)
pt5.AddText(str(T_M3000_W10nums[4]))
pt5.Draw()

pt6.AddText("ST > 400 GeV")
pt6.AddLine(00, .100, 1.00, .100)
pt6.AddText(str(DYToLLnums[5]))
pt6.AddLine(00, .200, 1.00, .200)
pt6.AddText(str(stnums[5]))
pt6.AddLine(00, .300, 1.00, .300)
pt6.AddText(str(tt_M2T4nums[5]))
pt6.AddLine(00, .400, 1.00, .400)
pt6.AddText(str(WToLNunums[5]))
pt6.AddLine(00, .500, 1.00, .500)
pt6.AddText(str(T_M1000_W10nums[5]))
pt6.AddLine(00, .600, 1.00, .600)
pt6.AddText(str(T_M1500_W10nums[5]))
pt6.AddLine(00, .700, 1.00, .700)
pt6.AddText(str(T_M2000_W10nums[5]))
pt6.AddLine(00, .800, 1.00, .800)
pt6.AddText(str(T_M2500_W10nums[5]))
pt6.AddLine(00, .900, 1.00, .900)
pt6.AddText(str(T_M3000_W10nums[5]))
pt6.Draw()

pt7.AddText("#geq 1 Higgs Candidate")
pt7.AddLine(00, .100, 1.00, .100)
pt7.AddText(str(DYToLLnums[6]))
pt7.AddLine(00, .200, 1.00, .200)
pt7.AddText(str(stnums[6]))
pt7.AddLine(00, .300, 1.00, .300)
pt7.AddText(str(tt_M2T4nums[6]))
pt7.AddLine(00, .400, 1.00, .400)
pt7.AddText(str(WToLNunums[6]))
pt7.AddLine(00, .500, 1.00, .500)
pt7.AddText(str(T_M1000_W10nums[6]))
pt7.AddLine(00, .600, 1.00, .600)
pt7.AddText(str(T_M1500_W10nums[6]))
pt7.AddLine(00, .700, 1.00, .700)
pt7.AddText(str(T_M2000_W10nums[6]))
pt7.AddLine(00, .800, 1.00, .800)
pt7.AddText(str(T_M2500_W10nums[6]))
pt7.AddLine(00, .900, 1.00, .900)
pt7.AddText(str(T_M3000_W10nums[6]))
pt7.Draw()

pt8.AddText("#Delta R(higgs,top) > 2")
pt8.AddLine(00, .100, 1.00, .100)
pt8.AddText(str(DYToLLnums[7]))
pt8.AddLine(00, .200, 1.00, .200)
pt8.AddText(str(stnums[7]))
pt8.AddLine(00, .300, 1.00, .300)
pt8.AddText(str(tt_M2T4nums[7]))
pt8.AddLine(00, .400, 1.00, .400)
pt8.AddText(str(WToLNunums[7]))
pt8.AddLine(00, .500, 1.00, .500)
pt8.AddText(str(T_M1000_W10nums[7]))
pt8.AddLine(00, .600, 1.00, .600)
pt8.AddText(str(T_M1500_W10nums[7]))
pt8.AddLine(00, .700, 1.00, .700)
pt8.AddText(str(T_M2000_W10nums[7]))
pt8.AddLine(00, .800, 1.00, .800)
pt8.AddText(str(T_M2500_W10nums[7]))
pt8.AddLine(00, .900, 1.00, .900)
pt8.AddText(str(T_M3000_W10nums[7]))
pt8.Draw()

pt9.AddText("Top P_{t} > 100 GeV")
pt9.AddLine(00, .100, 1.00, .100)
pt9.AddText(str(DYToLLnums[8]))
pt9.AddLine(00, .200, 1.00, .200)
pt9.AddText(str(stnums[8]))
pt9.AddLine(00, .300, 1.00, .300)
pt9.AddText(str(tt_M2T4nums[8]))
pt9.AddLine(00, .400, 1.00, .400)
pt9.AddText(str(WToLNunums[8]))
pt9.AddLine(00, .500, 1.00, .500)
pt9.AddText(str(T_M1000_W10nums[8]))
pt9.AddLine(00, .600, 1.00, .600)
pt9.AddText(str(T_M1500_W10nums[8]))
pt9.AddLine(00, .700, 1.00, .700)
pt9.AddText(str(T_M2000_W10nums[8]))
pt9.AddLine(00, .800, 1.00, .800)
pt9.AddText(str(T_M2500_W10nums[8]))
pt9.AddLine(00, .900, 1.00, .900)
pt9.AddText(str(T_M3000_W10nums[8]))
pt9.Draw()
